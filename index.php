				...
				<div class="container">
					...
					<div class="latest-grids">
						...
						<div class="col-md-4 latest-grid">
							...
							<a href="products.php?cat_id=<?php echo $row[0]?>;">	<img  src="images/<?php echo $row[2]; ?>" class="img-responsive"  alt="">
								<div class="latest-text"> </a>
									<a  href="products.php?cat_id=<?php echo $row[0]?>;"><h4><?php echo $row[1]; ?></h4></a>
								</div>
				...
				<div class="new-arrivals-w3agile">
					<div class="container">
						...
						<?php
							...
							$result = mysql_query("select * from products order by id DESC LIMIT 4",$link);
							$row = mysql_fetch_row($result);
							...
							<div class="news-gr">
								...
								<img src="images/p5.jpg" class="img-responsive" alt="">
									...
									<div class="women">
										...
										<p ><del>$100.00</del><em class="item_price"> $70.00 </em></p>
										<div class="add">
										   <button class="btn btn-danger my-cart-btn my-cart-b" data-id="3" data-name="Kabuli Chana" data-summary="summary 3" data-price="2.00" data-quantity="1" data-image="images/of2.png" name="addto" >Add to Cart</button>
										</div>
									</div>
								</div>
							</div>
